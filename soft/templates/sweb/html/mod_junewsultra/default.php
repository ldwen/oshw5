...
<div class="junewsultra <?php echo $params->get('moduleclass_sfx'); ?>">
	...
	<div class="jn" style="border:0px;">
		<?php if ($params->get('pik') && $i == 0): ?>
		<div class="jn-head">
			<div class="jn-left">
				<?php echo $item->image; ?>
			</div>
		...
		<div class="jn-more">
			...
			<a href="<?php echo $item->link; ?>" class="readmore"
				title="<?php echo $item->text_alt; ?>">
				<?php echo $params->def('rmtext'); ?>
			</a>
			<?php endif; ?>
			<?php if ($params->get('use_comments')): ?>
			<a class="jn-comment-link"
				href="<?php echo $item->link; ?><?php echo $item->commentslink; ?>">
				<?php echo $item->commentstext; ?>
			</a>
			<?php endif; ?>
		</div>
		<?php endif; ?>
	<?php else: ?>
		<li class="jn-list">
			<?php if ($params->get('show_title')):?>
				...
				<div style="float:right;">[<?php echo $item->date; ?>]</div>
			<?php endif;?>
		</li>
		<?php endif; ?>
	</div>
